    ...
    <body>
        ...
        <div style="background: #963ef5;" class="table-wrapper">
            <div style="background: #963ef5;" class="table-title">
                ...
                <div class="col-sm-6 button-group-area", style="margin-left: 40rem; margin-bottom: 50px">   
                    <a href="subjectmanage" >
                        <button class="btn btn-primary" >Back to Manage Subject</button>  </a>
                    <span><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#addone">
                            Add Question   
                        </button></span> 
        ...
        <div style="">
            <div style="" class="row">
                <div class="col-md-4">
                    <h1 style="color: purple">FILTER CHAPTER</h1><br>
                    <div>
