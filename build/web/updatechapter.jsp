        ...
        <jsp:include page="header.jsp"></jsp:include> 
            <div class="container">
                ...
                <div class="main-content">
                    <form id="chapterForm" action="updatechapter" method="Post">
                        <label for="chapter_no">Chapter No:</label>
                        <input type="text" id="chapter_no" name="chapter_no" value="${chapter.getChapter_no()}" readonly>
                    <label for="chapter_name">Chapter Name:</label>
                    <input type="text" id="chapter_name" name="chapter_name" value="${chapter.getChapter_name()}">
                    ...
                    <input class="hidden"  name="chapter_id" id="chapter_id" value="${chapter.getChapter_id()}"/>
