...
public class SearchBlogController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String title = request.getParameter("search_blog");
        String marketer_id = request.getParameter("marketer_id");
        ArrayList<Blog> data_blog;
        
        // check name search
        if (title.isBlank()) {
            data_blog = bd.selectAllBlogByMarketer_id(marketer_id);
        } else {
            data_blog = bd.searchBlogByTittle(title,marketer_id);
        }
