...
public class Learner_Subject {
    ...
    public Learner_Subject(String id, String learner_id, String subject_id, Date enrolled_date, String active, String status_id, String account_id, String fullname, String subject_name, String image, String lecturer_id, String lecturer_name, String category_id) {
        this.id = id;
        this.learner_id = learner_id;
        this.subject_id = subject_id;
        this.enrolled_date = enrolled_date;
