...
<html>
    ...
    <body>
        ...
        <form action="addsubject" method="post" class="add-subject-form mt-4">
            ...
            <div class="form-group">
                ...
                <input value="${param.image}" class="form-control" id="description" name="image" required></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input placeholder="Discount need to 0->100%"
                    value="${param.discount}" type="number" class="form-control" id="discount" name="discount" required>
            </div>
            <div class="form-group">
