                                    ...
                                    <tr>
                                        <td class="p-4">
                                            <div class="media align-items-center">
                                                ...
                                                <img <c:if test="${item.orderSubject.image eq null}">src="${item.orderSubject.image}"</c:if>
                                                                                                     <c:if test="${item.orderSubject.image ne null}">src="${item.orderSubject.image}"</c:if> 
                                                                                                         class="d-block ui-w-40 ui-bordered mr-4" alt="Subject Image">

                                                                                                     <div class="media-body">
                                                                                                         <a href="course-list?category_id=${item.orderSubject.category_id}&subject_id=${item.orderSubject.subject_id}" class="d-block text-dark">${item.orderSubject.subject_name}</a>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center align-middle px-0">
                                            <a href="/learnx/removeitem?subject_id=${item.orderSubject.subject_id}" class="shop-tooltip close float-none text-danger">×</a>
                                        </td>
                                    </tr>
                                </c:forEach>
