<%-- 
    Document   : index
    Created on : May 15, 2024, 11:43:03 PM
    Author     : Admin
--%>
          ...
          <div class="owl-carousel video-carousel">
            <div class="single-video">
              <div class="video-part">
                ...
                <a class="popup-youtube play-btn" href="https://www.youtube.com/watch?v=R1r9nLYcqBU">
                  <img class="play-icon" src="img/play-btn.png" alt="">
                </a>
              </div>
              <p class="text-white mb-20" style="margin-top: 30px;">
                In the history of modern astronomy, there is probably no one greater leap forward than the building and
                launch of the space telescope known as the Hubble.
              </p>
            </div>
      ...
      <div class="row align-items-end">
        ...
        <div class="offset-lg-3 col-lg-4 col-md-6">
          <div class="course-form-section">
            ...
            <form class="course-form-area contact-page-form course-form text-right" id="myForm" action="mail.jsp" method="post">
